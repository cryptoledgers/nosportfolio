...
//import decentralLogo from "./../../assets/exc.jpg";
import decentralLogo from "./../../assets/simple.png";
...
const SpinningLogo = ({ classes }) => (
  <div className={classes.logoContainer}>
    <img src={decentralLogo} className={classes.nosLogo} alt="nOS logo" key="nosLogo" />
  </div>
);
